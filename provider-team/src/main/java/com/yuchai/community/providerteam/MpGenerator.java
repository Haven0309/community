...
public class MpGenerator {
    public static void main(String[] args) {
        String outputDir = "D:\\workspace\\community\\provider-team\\src\\main\\java";
        String basePackage = "com.yuchai.community.providerteam";
        String[] tableNames = new String[]{"teams", "team_user", "user"};
